    ...
    const peoples = [
        {
            img: Max,
            name: 'Max Verveha',
            description: 'Max co-founded Datasoft Group with a personal ambition to change how businesses harness AI. As CEO, Max shapes the company’s vision, oversees strategic initiatives and leads Next-Gen AI Transformation practice. He focuses on navigating enterprises through a complex world of AI and transforming them towards AI-driven leaders. Leveraging his expertise gained at EY-Parthenon, Deloitte and Google, Max maintains a strong background on the intersection of business and technology. Max holds a BSc in Management from the University College London (UCL) and Joint MSc Management & CEMS degrees from the London School of Economics (LSE) and Korea University. Beyond his professional pursuits, Max is an avid skier, enjoy travel and active leisure',
        ...
        },
        {
            ...
            description: 'Mykola co-founded Datasoft Group with a personal mission to redefine the application of AI in modern industries. As CTO, Mykola leverages his deep expertise in Generative AI to define the company’s technical vision and drives innovation across its offerings, including the flagship AI Copilot solutions. With over 6 years of experience in the AI field, he has led the development of impactful AI solutions for major multinational corporations, bridging cutting-edge technology with real-world applications. Mykola holds a BSc and MSc in Applied Science from the Ukrainian Catholic University and Lviv National Polytechnic University and pursued studies at Rushford Business School in Geneva. Outside of work, Mykola is a professional chess player who has competed internationally, enjoys traveling, music, and art.',
        ...
        },
        {
            ...
            description: "Roman is a Senior Associate at Datasoft Group, where he contributes to crafting cutting-edge solutions as an engineer within Data Platforms practice. With a strong foundation in applied mathematics, he combines technical expertise with creative problem-solving to deliver seamless and impactful digital experiences. Roman obtained a BSc in Applied Mathematics at Lviv Polytechnic National University with focus on algorithm design and system architecture. Beyond his professional pursuits, Roman formerly was a part of Ukrainian Premier League side FC Lviv. He also enjoys immersing himself in books, exploring new ideas, and practising meditation.",
