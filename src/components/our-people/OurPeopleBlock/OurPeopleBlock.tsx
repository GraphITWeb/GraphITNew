    ...
    return (<>
            <div ref={ourPeopleRef} className="our__people">
                <People imgUser={Max} name='Max Verveha'
                        description='Max co-founded Graphit alongside Nick, Sviat & Mykola with a personal ambition to redefine how businesses harness AI. As CEO, Max shapes the company’s vision, oversees strategic initiatives and leads Next-Gen AI Transformation practice. He focuses on navigating enterprises through a complex world of AI and transforming them towards AI driven leaders. Leveraging his expertise gained at EY-Parthenon, Deloitte, Softserve and Google, Max has a strong background in crafting strategies on the intersection of business and technology. Max holds a BSc in Management from the University College London (UCL) and Joint MSc Management & CEMS degrees from the London School of Economics (LSE) and Korea University. Beyond his professional pursuits, Max is an avid skier and a lover of adventure, always keen to explore new heights — both on the slopes and in business.'
                ...
                <People imgUser={Mykola} name='Mykola Kyrychenko'
                        description='Mykola co-founded Graphit alongside Nick, Max & Sviat. His personal mission is to revolutionise the application of AI in modern industries, leveraging his deep expertise in Generative AI long before it became mainstream. As CTO, Mykola defines the company’s technical vision and drives innovation across its offerings, including the flagship AI Copilot solutions. With over 6 years of experience in the AI field, he has led the development of impactful AI solutions for major multinational corporations, bridging cutting-edge technology with real-world applications. Mykola holds a BSc and MSc in Applied Science from the Ukrainian Catholic University (UCU) and Lviv National Polytechnic University and pursued studies at Rushford Business School in Geneva. Outside of work, Mykola is a professional chess player who has competed internationally, enjoys traveling, music, and art.'
