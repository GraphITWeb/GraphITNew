...
const Unlocked = () => {
    ...
    return (
        <div id="container" className="unlocked_container">
            ...
            <svg className="pc" style={{position: 'absolute', right: 0, bottom: '-70vh',zIndex:-1}}  xmlns="http://www.w3.org/2000/svg" width="346" height="834" viewBox="0 0 346 834" fill="none">
                <path fill-rule="evenodd" clip-rule="evenodd"
