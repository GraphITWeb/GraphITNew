        ...
        <div className="feedback" style={{zIndex:1}}>
            ...
            <div className="feedback__items" ref={reviewRef}>
                <FeedbackItem imgUser={Ales}
                              description={`Datasoft Group's "Talk-To-Your-Data" AI Copilot has been a game-changer for our organization. Enabling customers to seamlessly interact with data boosted user’s platform engagement, made complex insights easily accessible and further informed analyst’s decision-making. translated into a substantial uptick in subscriptions to our platform. Datasoft Group's AI Copilot has not only made our data more accessible but also turned it into a strategic advantage that powers our growth.`}
                              name="Ales Prochazka"
                              position="CEO of Legaltools"
                />
                <FeedbackItem imgUser={Ruslan}
                              description="Datasoft Group provided us with a clear, actionable strategy for AI adoption. By identifying the most suitable AI use-cases for our business, they significantly facilitated and accelerated AI solution roll-out across our department, ensuring it targeted actual business bottlenecks. Thanks to their approach, we became a data-driven organization and substantially streamlined our operations, resulting in increased efficiency and measurable growth. Focusing on our needs ensured that the transformation was both effective and relevant to our internal KPIs."
                              name="Ruslan Kravets"
                              position="CEO of Medikit"
                />
                <FeedbackItem imgUser={Pavel}
                              description="Working with Datasoft Group has transformed our approach to data management at Libernetix. Their contributions helped develop an efficient, intelligent and automated data analytics system, complemented by real-time dashboarding, which streamlined our operations and decision-making processes. Beyond their technical expertise, Datasoft Group team’s value-first mindset played a key role in creating a 360° view of the business and substantially boosted overall operational efficiency."
                              name="Pavel Yeliseev"
                              position="CTO of Libernetix"
                />
                <FeedbackItem imgUser={Nima}
                              description="Datasoft Group has been an incredible asset to us at Broya. Their technical expertise combined with business acumen are not only profound but also practically applied to real-world problems. Their work has significantly contributed to the success of our e-commerce revenue growth through data analytics capability roll-out enabling us to monitor factors such as customer lifetime and forecast demand. Datasoft Group team is extremely professional and a pleasure to work with."
                              name="Nima Sotoadeh"
