...
export const metadata: Metadata = {
    title: "Datasoft Group | Our Team",
    description:"At Datasoft Group, our team unites scientific expertise with business acumen, crafting innovative solutions that blend technical excellence with real-world impact to drive our clients forward."
}
