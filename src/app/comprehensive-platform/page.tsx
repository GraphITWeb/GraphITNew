...
import Case from '../../assets/Netflix2.jpg'
    ...
    return (
        <div className="case__study">
            <Main subText={'Case study • 8 min read'}
                  header="Сomprehensive Platform Development for Major Telecom Company"
            ...
            <div className="case__study__text">
                ...
                <div className="case__study__text__dots">
                    ...
                    <p>
                        Enabled Client to attract and retain high-profile clients such as Disney and Netflix,
                ...
                <div className="case__study__text__dots">
                    ...
                    <p>
                        ...
                        interruptions, solidifying Client&#39;s industry leadership.
                    </p>
                </div>
                <h4>Context</h4>
                <p>Client, a major American telecom company, sought to revolutionize its network management
                ...
                <p>
                    ...
                    needs. From a business perspective, Client needed to differentiate itself to attract and retain
                    ...
                    collaboration and rigorous testing to ensure the platform aligned perfectly with Client&#39;s
                    business
                ...
                <p>
                    ...
                    all major cloud providers. This allowed Client the freedom to deploy on any preferred cloud
                    ...
                    the platform met Client’s reliability and performance expectations. Weekly demos with stakeholders
                ...
                <div className="case__study__impact">
                    <h4>Impact & Beyond</h4>
                    <p>
                        Our solution enabled Client to achieve critical performance thresholds, processing over 500,000
                        events per second with less than 3 seconds latency. This allowed Client to attract and retain
                        ...
                        deployment flexibility, resonating with high-value clients and enhancing Client&#39;s position
                        as
                        an industry leader.
                    </p>
                </div>
