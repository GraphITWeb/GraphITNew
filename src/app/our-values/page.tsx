...
export const metadata: Metadata = {
    title: "Datasoft Group | Our Values",
    description:"At Datasoft Group, our core values—Innovate, Redefine, Transform—drive everything we do. These principles guide our approach to tackling complex client challenges."
}
        ...
        <div className="flex flex-col items-center justify-items-center p-0">
            ...
            <div className="our__value__what">
                ...
                <TechnicalWhatBlock header="Responsible AI"
                                    description="AI holds transformative potential, and with it comes responsibility. Datasoft Group helps clients design, deploy, and manage AI in a way that builds trust, mitigates risks, and maximizes value—ensuring AI serves as a force for good."/>
                <TechnicalWhatBlock header="Driving Positive Impact"
                                    description="We are dedicated to creating meaningful impact for our clients, our people, and the communities we serve. At Datasoft Group, we believe in responsible leadership that drives progress, supports sustainability, and builds a better future for all."
                                    />
                ...
                <TechnicalWhatBlock header="Commitment to Ethical Business"
                                    description="At Datasoft Group, integrity is at the heart of everything we do. Our team is united by a commitment to doing what’s right, providing exceptional value for our clients while upholding the highest ethical standards. This dedication to ethical business practices is what sets us apart."/>
